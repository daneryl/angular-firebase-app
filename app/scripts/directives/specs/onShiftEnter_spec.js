...
describe('Directive: onShiftEnter', function() {
  ...
  beforeEach(inject(function($rootScope, $compile){
    element = $('<input on-shift-enter="method()"/>');
    scope = $rootScope.$new();
  ...
  describe('on focus', function(){
    it('should add should add enter event that executed method passed', function(){
      ...
      expect(event_added.combo).toBe('shift+enter');
  ...
  describe('on blur', function(){
    it('should remove enter event', function(){
      ...
      expect(hotkeys.del).toHaveBeenCalledWith('shift+enter');
    });
  });
